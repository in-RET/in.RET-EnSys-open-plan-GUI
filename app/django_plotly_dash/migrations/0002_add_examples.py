...
def addExamples(apps, schema_editor):
    ...
    sa1 = StatelessApp(app_name="SimpleExample", slug="simple-example")
    ...
    sa2 = StatelessApp(app_name="LiveOutput", slug="liveoutput")

    sa2.save()

    sa21 = StatelessApp(app_name="LiveInput", slug="liveinput")
...
""",
    ...
    sa3 = StatelessApp(app_name="Ex2", slug="ex2")
    ...
    sa4 = StatelessApp(
        app_name="MultipleCallbackValues", slug="multiple-callback-values"
    )
    ...
    sa5 = StatelessApp(
        app_name="MultipleCallbackValuesExpanded",
    ...
    sa6 = StatelessApp(app_name="PatternStateCallbacks", slug="pattern-state-callback")
...
class Migration(migrations.Migration):
    ...
    dependencies = [("django_plotly_dash", "0001_initial")]

    operations = [migrations.RunPython(addExamples, remExamples)]
