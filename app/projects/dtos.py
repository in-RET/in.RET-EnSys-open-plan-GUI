...
class AssetDto:
    def __init__(
        ...
        trafo_input_bus_1: str,
        trafo_input_bus_2: str,
        trafo_input_bus_3: str,
        trafo_output_bus_1: str,
        trafo_output_bus_2: str,
        ...
        self.trafo_input_bus_1 = trafo_input_bus_1
        self.trafo_input_bus_2 = trafo_input_bus_2
        self.trafo_input_bus_3 = trafo_input_bus_3
        self.trafo_output_bus_1 = trafo_output_bus_1
        self.trafo_output_bus_2 = trafo_output_bus_2
        self.trafo_output_bus_3 = trafo_output_bus_3
    ...
    for asset in asset_list:
        ...
        if asset.asset_type.asset_type == "myTransformer":
            ...
            asset_dto = AssetDto(
                ...
                asset.trafo_input_bus_1,
                asset.trafo_input_bus_2,
                asset.trafo_input_bus_3,
                asset.trafo_output_bus_1,
                asset.trafo_output_bus_2,
                asset.trafo_output_bus_3,
