    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "unique_id",
                    models.CharField(
                        default=uuid.uuid4, editable=False, max_length=120, unique=True
                    ),
                ),
                (
                    "capex_fix",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "flow_direction",
                    models.CharField(
                        choices=[("B2A", "Bus_to_Asset"), ("A2B", "Asset_to_Bus")],
                        max_length=15,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "unit",
                    models.CharField(default="kgCO2eq/a", editable=False, max_length=9),
                ),
                (
                    "name",
                    models.CharField(
                        default="maximum_emissions", editable=False, max_length=30
                    ),
                ),
            ],
            options={"abstract": False},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "unit",
                    models.CharField(default="factor", editable=False, max_length=6),
                ),
                (
                    "name",
                    models.CharField(
                        default="minimal_degree_of_autonomy",
                        editable=False,
                        max_length=30,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        default="minimal_renewable_factor",
                        editable=False,
                        max_length=30,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        default="net_zero_energy", editable=False, max_length=30
                    ),
                ),
            ],
            options={"abstract": False},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(blank=True, null=True, upload_to="tempFiles/"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "variable_reference",
                    models.FloatField(
                        help_text="The value of the variable parameter for the reference scenario of the sensitivity analysis, if is it different than the value of the current scenario user need to decide whether to take current scenario as reference with its actual value for this parameter, duplicate the scenario and use the duplicata with chosen reference value or keep current scenario but change parameter value to chosen one"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "share_rights",
                    models.CharField(
                        choices=[("edit", "Edit"), ("read", "Read")], max_length=10
                    ),
                ),
            ],
        ),
