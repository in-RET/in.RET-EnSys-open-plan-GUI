...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='asset',
            name='existing',
            field=models.FloatField(default=None, null=True, validators=[django.core.validators.MinValueValidator(0.0)]),
        ),
        migrations.AddField(
            model_name='asset',
            name='maximum',
        ...
        migrations.AddField(
            model_name='asset',
            name='nonconvex',
            field=models.BooleanField(choices=[(None, 'Choose'), (True, 'Yes'), (False, 'No')], default=False, null=True),
        ),
        migrations.AddField(
            model_name='asset',
            name='offset',
